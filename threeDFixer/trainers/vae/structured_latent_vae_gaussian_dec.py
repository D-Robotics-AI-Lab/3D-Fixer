...
class SLatVaeGaussianDecoderTrainer(BasicTrainer):
    ...
    def training_losses(
        ...
        **kwargs
        ...
        """
        z, mean, logvar = self.frozen_models['encoder'](feats, sample_posterior=True, return_raw=True)
    ...
    def run_snapshot(
        ...
        for i in range(0, num_samples, batch_size):
            ...
            z = self.frozen_models['encoder'](args['feats'], sample_posterior=True, return_raw=False)
