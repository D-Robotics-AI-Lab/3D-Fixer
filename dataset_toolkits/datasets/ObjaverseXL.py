...
def get_metadata(source, **kwargs):
    if source == 'sketchfab':
        metadata = pd.read_csv("hf://datasets/HorizonRobotics/ARSG-110K/ObjaverseXL_sketchfab.csv")
    elif source == 'github':
        metadata = pd.read_csv("hf://datasets/HorizonRobotics/ARSG-110K/ObjaverseXL_github.csv")
    else:
